...
class DeliveredShipmentsPage extends StatefulWidget {
  const DeliveredShipmentsPage({Key? key}) : super(key: key);

  @override
  _DeliveredShipmentsPageState createState() => _DeliveredShipmentsPageState();
}

class _DeliveredShipmentsPageState extends State<DeliveredShipmentsPage> {
