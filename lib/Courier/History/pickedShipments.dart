...
class PickedShipmentsPage extends StatefulWidget {
  const PickedShipmentsPage({Key? key}) : super(key: key);

  @override
  _PickedShipmentsPageState createState() => _PickedShipmentsPageState();
}

class _PickedShipmentsPageState extends State<PickedShipmentsPage> {
